...
const A = 'squads/carrossel-vitaegold/output/_build/blog-hidratacao/assets';
const OUT = 'squads/carrossel-vitaegold/output/blog-hidratacao/images';
...
const slides = [
  { n: 1, photo: b64('s1.jpg', 'image/jpeg'), pos: 'center 35%',
    headline: 'Às vezes, o cansaço é só falta de água.',
    body: 'A sede engana — ainda mais com a idade. Beber água ao longo do dia cuida da sua energia e até das articulações.' },
  { n: 2, photo: b64('s2.jpg', 'image/jpeg'), pos: 'center 45%', pill: 'Por quê',
    headline: 'A água faz o corpo inteiro funcionar.',
    body: 'Ela transporta nutrientes, regula a temperatura e lubrifica as articulações. Pouca água? Vem o cansaço, a dor de cabeça e a falta de foco.' },
  { n: 3, photo: b64('s3.jpg', 'image/jpeg'), pos: 'center 30%', pill: 'A sede engana',
    headline: 'Não espere a sede chegar.',
    body: 'No calor ou no ar-condicionado, o corpo perde água sem avisar. Beber aos poucos, com regularidade, funciona melhor do que esperar a sede.' },
  { n: 4, photo: b64('s4.jpg', 'image/jpeg'), pos: 'center 50%', pill: 'Na prática',
    headline: 'Um truque simples: olhe a cor.',
    body: 'Urina bem clara costuma indicar boa hidratação. E nem tudo vem do copo — melancia, laranja e pepino também hidratam.' },
  { n: 5, photo: b64('s5.jpg', 'image/jpeg'), pos: 'center 35%',
    headline: 'Deixe a garrafa por perto.',
    body: 'Um copo de cada vez, ao longo do dia. Pequeno hábito, grande diferença na sua disposição.' },
];
...
await browser.close();
console.log('DONE blog-hidratacao');
