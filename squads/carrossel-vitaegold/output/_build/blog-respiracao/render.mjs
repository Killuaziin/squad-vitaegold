...
const A = 'squads/carrossel-vitaegold/output/_build/blog-respiracao/assets';
const OUT = 'squads/carrossel-vitaegold/output/blog-respiracao/images';
...
const slides = [
  { n: 1, photo: b64('s1.jpg','image/jpeg'), pos:'center 30%',
    headline:'Você carrega uma ferramenta poderosa contra o estresse: a sua respiração.',
    body:'Simples, silenciosa e sempre com você. Aprender a usá-la com calma muda como você enfrenta o dia.' },
  { n: 2, photo: b64('s2.jpg','image/jpeg'), pos:'center 40%', pill:'Por que funciona',
    headline:'Respirar devagar acalma o corpo.',
    body:'A respiração é um dos poucos processos que a gente controla. Mais lenta e profunda, ela avisa ao corpo que pode relaxar.' },
  { n: 3, photo: b64('s3.jpg','image/jpeg'), pos:'center 40%', pill:'Técnica 1',
    headline:'Respire com a barriga, não com o peito.',
    body:'Uma mão no abdômen. Inspire pelo nariz sentindo a barriga subir. Solte devagar pela boca. Repita de 5 a 10 vezes, sem pressa.' },
  { n: 4, photo: b64('s4.jpg','image/jpeg'), pos:'center 35%', pill:'Técnica 2',
    headline:'Conte enquanto respira.',
    body:'Inspire contando até 4, segure até 7 e solte até 8. A expiração mais longa é o que mais acalma. Ótima antes de dormir.' },
  { n: 5, photo: b64('s5.jpg','image/jpeg'), pos:'center 35%',
    headline:'Um minuto de respiração já muda o seu dia.',
    body:'Dá pra fazer em qualquer lugar, sem ninguém perceber. Experimente quando a tensão apertar.' },
];
function render(s){
...
await browser.close(); console.log('DONE respiracao');
